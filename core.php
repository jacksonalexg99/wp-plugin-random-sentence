...
if ( is_admin() ) {
	...
	function register_style_js() {
		...
		wp_enqueue_script( 'script_rs', RS_PLUGIN_URL . 'assets/js/dashboard.js', [ 'jquery' ], '1.0.0', false );
		wp_enqueue_script( 'bootstrap_rs', RS_PLUGIN_URL . 'assets/js/bootstrap.min.js','' ,'5.2.3',false );
		wp_enqueue_script( 'popper_rs', RS_PLUGIN_URL . 'assets/js/popper.min.js','', '1.0.0',false );
		wp_enqueue_script( 'toast_rs', RS_PLUGIN_URL . 'assets/js/toast.js' );
	    wp_enqueue_script( 'jscolor_rs', RS_PLUGIN_URL . 'assets/js/jscolor.min.js', [ 'jquery' ],'1.0.0' ,false);
